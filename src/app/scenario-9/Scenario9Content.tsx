...
/** Async content that reads searchParams, cookies, headers. Wrapped in Suspense for cacheComponents. */
export async function Scenario9Content({ searchParams }: Props) {
