...
export default async function Scenario8Page() {
  ...
  const sfContext = userId ? await getSalesforceUserContextCached(userId) : null;
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-zinc-400">
          Page is dynamic (RSC). Server reads userId from cookie and fetches user context from
      ...
      <ScenarioExplanation
        ...
        steps={[
          ...
          "Server calls getSalesforceUserContextCached(userId), which uses unstable_cache(..., [userId], { revalidate: 60 }).",
        ...
        vercelUsage={[
          ...
          "Salesforce user context is cached per userId via unstable_cache; repeat visits by same user do not refetch.",
